...
import com.example.navienha.databinding.ActivityNaviDrawerBinding;
...
public class NaviDrawer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.calculadora2,R.id.sonido2, R.id.direccionarApk2, R.id.sitioWeb2, R.id.maravilla, R.id.maps)
                .setOpenableLayout(drawer)
                .build();
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_navi_drawer);
