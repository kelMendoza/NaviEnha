...
public class Calculadora extends Fragment {
    ...
    private View view;
    private Button btnSuma, btnResta, btnMultiplicar, btnDividir, btnClear, btnIgual, btnPunto, btnPorcentaje;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnMultiplicar = view.findViewById(R.id.btnproducto);
        ...
        btnDividir = (Button) view.findViewById(R.id.btndiv);
